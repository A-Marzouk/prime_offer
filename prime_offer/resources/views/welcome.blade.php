    ...
    <section id="intro" class="section intro">
        <div class="container">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <p>
                    PRIME OFFER digital agency offers a wide range of digital marketing services for businesses in the European, Asian markets & now we’re expanding to the Arabic market. We are professionals in social media marketing (SMM), creating brand awareness, search engine optimization (SEO), email marketing, web analytics and website development.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 services text-center"> <span class="icon icon-tools"></span>
                    <div class="services-content">
                        ...
                        <p>
                            Our programmers will develop a website that will convert your site visitors into profitable customers. Before development, we will research your target audience. Then we can offer an optimal version of the site structure, the way of navigation and design.
                            We use only updated and mobile ready software solutions. Our sites are easy to administer, which allows you to change the content on the pages readily.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <form role="form" action="" method="post" style="margin-top: 50px;">
                            ...
                            <div class="row setup-content-2" id="step-3">
                                <div class="col-md-12">
                                    <div  class="stepText">
                                        <span>Analyse your market and Propose an optimal solution based on your budget.</span>
                                    </div>
                                    <button class="btn btn-mdb-color btn-rounded prevBtn-2 float-left" type="button">Previous</button>
                                    <button class="btn btn-mdb-color btn-rounded nextBtn-2 float-right" type="button">Next</button>
                                </div>
                            ...
                            <div class="row setup-content-2" id="step-4">
                                <div class="col-md-12">
                                    <div  class="stepText">
                                    <span>
                                        Coordinate with you the strategy and financial issues.
                                    </span>
                                    </div>
                                    <button class="btn btn-mdb-color btn-rounded prevBtn-2 float-left" type="button">Previous</button>
                                    <button class="btn btn-mdb-color btn-rounded nextBtn-2 float-right" type="button">Next</button>
                            ...
                            <div class="row setup-content-2" id="step-6">
                                <div class="col-md-12">
                                    <div  class="stepText">
                                        <span>Then, we are ready beginning a new challenge.</span>
                                    </div>
                                    <button class="btn btn-mdb-color btn-rounded prevBtn-2 float-left" type="button">Previous</button>
                                </div>
                            </div>
